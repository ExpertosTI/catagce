-- Planes Free / Pro / Enterprise + features modulares + platform admins
-- Idempotente — no DROP
-- Free: sin Difusión, Pedidos ni Inbox. Pro ($6) y Enterprise ($25) los incluyen.
...
INSERT INTO plans (code, name, description, sort_order) VALUES
  ('free', 'Free', 'Catálogo y compartir por WhatsApp', 0),
  ('pro', 'Pro', 'Difusión, pedidos e inbox — $6 USD/mes', 1),
  ('business', 'Enterprise', 'Sin límites + IA — $25 USD/mes', 2)
...
INSERT INTO plan_features (plan_code, feature_key, enabled, limit_value) VALUES
  ...
  ('business', 'orders', true, NULL),
  ('business', 'inbox', true, NULL),
