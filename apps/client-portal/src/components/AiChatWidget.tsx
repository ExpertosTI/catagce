...
export function AiChatWidget() {
  ...
  async function send(text?: string) {
    ...
    setLoading(true);
    try {
      const res = await apiFetch<{ reply: string }>('/portal/ai/chat', {
        method: 'POST',
          ...
          <div className="ai-chat-header">
            <div className="flex items-center gap-2">
              ...
              <div>
                ...
                <p className="text-[11px] opacity-80">Ayuda sobre sus facturas</p>
              </div>
            </div>
          ...
          <div className="ai-chat-body">
            {messages.length === 0 && (
              <div className="space-y-3">
                <p className="text-sm text-slate-500">Pregúnteme sobre sus facturas, saldo o pedidos.</p>
