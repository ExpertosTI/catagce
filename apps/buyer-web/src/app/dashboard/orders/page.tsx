...
const statusLabels: Record<string, { label: string; color: string }> = {
  draft_capture: { label: 'Borrador WA', color: '#a855f7' },
  submitted: { label: 'Nuevo', color: '#00D1FF' },
  reserved: { label: 'Reservado', color: '#FF8A00' },
  pending_seller_review: { label: 'En revisión', color: '#f59e0b' },
              ...
              <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                <div>
                  <div className="flex items-center gap-3 mb-2">
                    ...
                    {order.source && (
                      <span className="px-2 py-0.5 rounded-full text-[10px] font-semibold bg-[#25D366]/15 text-[#25D366]">
                ...
                <div className="flex items-center gap-4">
                  ...
                  {(order.status === 'submitted' || order.status === 'draft_capture' || order.status === 'reserved') && (
