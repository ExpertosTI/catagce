...
import { ShoppingBag, Box, Zap, ArrowRight, ShieldCheck, Globe, Smartphone, BarChart3, ChevronRight, Play } from 'lucide-react';
  ...
  return (
    <div className="relative min-h-screen bg-[#050505] text-white selection:bg-[#00D1FF]/30 overflow-hidden font-sans selection:text-black">
      ...
      <div className="fixed inset-0 pointer-events-none z-0">
        ...
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_50%_-20%,rgba(0,209,255,0.15),transparent_70%)]" />
      </div>
