...
type Stats = {
  ...
  endsAt: string;
  totalVotes: number;
  ranking: Array<{ id: string; name: string; points: number }>;
};
        ...
        {!thanks && (
          <>
            ...
            <p className="mt-3 text-sm leading-relaxed text-white/60">
              Elige 3 nombres en orden. El primero es tu favorito.
              Toma menos de 20 segundos — gracias por ayudarnos a construir esto.
            </p>
          </>
        )}
        ...
        {thanks && (
          <section className="mt-8 rounded-3xl border border-[#00D1FF]/25 bg-[#00D1FF]/10 p-6 text-center">
            ...
            <p className="mt-2 text-sm leading-relaxed text-white/70">
              ...
              tecnología simple, hecha con cariño.
            </p>
          </section>
        )}
        ...
        {!loading && survey?.isOpen && !voted && (
          <section className="mt-8 space-y-2.5">
            {survey.options.map((opt) => {
              ...
              return (
                ...
                >
                  ...
                  <span className="text-lg font-bold tracking-tight">{opt.name}</span>
                </button>
              );
            })}
            ...
            <button
              ...
              className="mt-2 w-full rounded-2xl bg-[#00D1FF] py-3.5 text-base font-black text-black disabled:opacity-40"
            >
