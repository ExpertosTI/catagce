...
exports.runEmbeddedMigrations = runEmbeddedMigrations;
/**
...
exports.MIGRATIONS = [
    ...
    {
        id: '20260513_0001_repair_global_schema_v2',
...
async function runEmbeddedMigrations(db, logger) {
  ...
  `);
    const appliedRows = await db.execute((0, drizzle_orm_1.sql) `SELECT id FROM __catagce_migrations__`);
    const appliedSet = new Set(appliedRows.map((r) => r.id || r.ID));
