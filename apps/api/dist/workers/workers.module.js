...
exports.WorkersModule = WorkersModule = __decorate([
    (0, common_1.Module)({
        imports: [
            bullmq_1.BullModule.registerQueue({ name: 'notifications' }, { name: 'media' }),
        ],
        providers: [notifications_processor_1.NotificationsProcessor, media_processor_1.MediaProcessor],
    })
], WorkersModule);
